  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between items-center p-2">
        <input
          className="border-2 border-gray-300 rounded-md w-4/6 p-2 focus:ring-2 focus:ring-[#14815f] focus:outline-none"
          placeholder="Search here"
          type="text"
        />
        <Link to="/dashboard/gameCategories">
          <button className="text-xl  bg-[#8458B3] hover:bg-yellow-500 text-white p-2  rounded-md transition duration-300">
            + Add
          </button>
        </Link>
      </div>
